...
<script type="text/javascript">
    ...
    $(function() {
        ...
        var currentPage = 1;
        var total = total;
        var totalPages = total%10==0 ? total/10 : total/10+1;
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data.rows,function(index,row){
                    //alert(news)
                    $("#ulData").append("<li class='clearfix'><div class='id_col'>"+row.courCode+"</div><div class='name_col'>"+row.schName+"</div><div class='name_col'>"+row.courName+"</div><div class='name_col'>"+row.courInfo+"</div></li>");  //将返回的数据追加到表格
                });
            }
        });
        return total;
