            ...
            <tr  name="remark">
                ...
                <td class="product-details">
                    ...
                    <div class="remarktitle">
                        <h3 class="title remarkh3"><strong>${union.courName}<br><br></strong><h6 class="remarkh6">${union.courInfo}</h6></h3>
                    </div>
                    ...
                    <div class="">
                        <ul class="list-inline justify-content-center">
                            <li class="list-inline-item">
                                ...
                                <a class="edit" name="confirm" href="#" onclick="userComment(${union.courId})">
